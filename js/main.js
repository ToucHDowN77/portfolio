...
(function(html) {
    ...
    const cfg = {
        ...
        finalDate : 'October 01, 2021 12:30:15',
        finalDate2 : 'December 01, 2021 09:45:24',
        finalDate3 : 'September 20, 2021 10:00:00',
        // MailChimp URL
    ...
    * ------------------------------------------------------ */
    ...
    /* Countdown Timer 2
    * ------------------------------------------------------ */
    const ssCountdown2 = function () {

        

        const finalDate2 = new Date(cfg.finalDate2).getTime();
        const daysSpan2 = document.querySelector('.counter .ss-days2');
        const hoursSpan2 = document.querySelector('.counter .ss-hours2');
        const minutesSpan2 = document.querySelector('.counter .ss-minutes2');
        const secondsSpan2 = document.querySelector('.counter .ss-seconds2');
        let timeInterval2;

        if (!(daysSpan2 && hoursSpan2 && minutesSpan2 && secondsSpan2)) return;

        function timer2() {

            const now2 = new Date().getTime();
            let diff2 = finalDate2 - now2;
            ...
            let minutes2 = Math.floor( (diff2/1000/60) % 60 );
            let seconds2 = Math.floor( (diff2/1000) % 60 );
            ...
            hours2 <= 9 ? hours2 = '0' + hours2 : hours2;
            minutes2 <= 9 ? minutes2 = '0' + minutes2 : minutes2;
            seconds2 <= 9 ? seconds2 = '0' + seconds2 : seconds2;

            daysSpan2.textContent = days2;
            hoursSpan2.textContent = hours2;
            minutesSpan2.textContent = minutes2;
            secondsSpan2.textContent = seconds2;

        }

        timer2();
        timeInterval2 = setInterval(timer2, 1000);
    };
    
    /* Countdown Timer 3
    * ------------------------------------------------------ */
    const ssCountdown3 = function () {

        const finalDate3 = new Date(cfg.finalDate3).getTime();
        const daysSpan3 = document.querySelector('.counter .ss-days3');
        const hoursSpan3 = document.querySelector('.counter .ss-hours3');
        const minutesSpan3 = document.querySelector('.counter .ss-minutes3');
        const secondsSpan3 = document.querySelector('.counter .ss-seconds3');
        let timeInterval3;

        if (!(daysSpan3 && hoursSpan3 && minutesSpan3 && secondsSpan3)) return;

        function timer3() {

            const now3 = new Date().getTime();
            let diff3 = finalDate3 - now3;
            ...
            let days3 = Math.floor( diff3/(1000*60*60*24) );
            let hours3 = Math.floor( (diff3/(1000*60*60)) % 24 );
            let minutes3 = Math.floor( (diff3/1000/60) % 60 );
            let seconds3 = Math.floor( (diff3/1000) % 60 );
            ...
            hours3 <= 9 ? hours3 = '0' + hours3 : hours3;
            minutes3 <= 9 ? minutes3 = '0' + minutes3 : minutes3;
            seconds3 <= 9 ? seconds3 = '0' + seconds3 : seconds3;

            daysSpan3.textContent = days3;
            hoursSpan3.textContent = hours3;
            minutesSpan3.textContent = minutes3;
            secondsSpan3.textContent = seconds3;

        }

        timer3();
        timeInterval3 = setInterval(timer3, 1000);
    };
